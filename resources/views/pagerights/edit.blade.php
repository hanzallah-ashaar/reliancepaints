            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/rights', [$page -> id]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('old_page_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="old_page_id" type="number" class="form-control" name="old_page_id" value="{{$page -> id}}">
